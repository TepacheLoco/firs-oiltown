...
industry_numeric_ids = dict(
    ...
    desalination_plant=125,
    coking_plant=126,
    petrochemical_plant=39,
    power_station=21,
    water_tower=27,
    lubricants_plant=31,
    bitumen_plant=45,
    fracking_well=46,
    fracking_fluid_plant=59,
    petroleum_fuels_depot=40,
    export_terminal=42,
...
tile_numeric_ids = dict(
    ...
    gas_processing_plant_tile_2=15,
    gas_processing_plant_tile_3=18,
    desalination_plant_tile_1=7,
    desalination_plant_tile_2=8,
    desalination_plant_tile_3=9,
    coking_plant_tile_1=10,
    coking_plant_tile_2=11,
    coking_plant_tile_3=12,
    petrochemical_plant_tile_1=13,
    petrochemical_plant_tile_2=14,
    power_station_tile_1=16,
    power_station_tile_2=17,
    water_tower_tile_1=22,
    lubricants_plant_tile_1=23,
    bitumen_plant_tile_1=24,
    bitumen_plant_tile_2=25,
    fracking_fluid_plant_tile_1=26,
    fracking_fluid_plant_tile_2=27,
    fracking_well_tile_1=28,
    fracking_well_tile_2=29,
    petroleum_fuels_depot_tile_1=30,
    export_terminal_tile_1=31,
    export_terminal_tile_2=32,
    export_terminal_tile_3=33,
...
metadata = {
    ...
    "docs_url": "https://firs-forked.com",
}
...
graphics_temp_storage = dict(
    ...
    var_production_gate_closed=21, # bool, 1 when a require_all_inputs_for_production secondary has current_production_ratio == 0 in the current economy; used to suppress smoke/fire sprites
