...
industry.add_magic_spritelayout(
    ...
    base_id="oil_trading_port_spritelayout_coast_office",
    tile="oil_trading_port_tile_2",
    config={
...
industry.add_magic_spritelayout(
    type="jetty_auto_orient_to_coast_direction",
    base_id="oil_trading_port_spritelayout_sphere_tank",
    tile="oil_trading_port_tile_1",
    config={
        "jetty_foundations": True,
        "building_sprites": {
...
industry.add_magic_spritelayout(
    type="jetty_auto_orient_to_coast_direction",
    base_id="oil_trading_port_spritelayout_small_tanks",
    tile="oil_trading_port_tile_1",
    config={
        "jetty_foundations": True,
        "building_sprites": {
...
industry.add_magic_spritelayout(
    type="jetty_auto_orient_to_coast_direction",
    base_id="oil_trading_port_spritelayout_large_tank",
    tile="oil_trading_port_tile_1",
    config={
        "jetty_foundations": True,
        "building_sprites": {
...
industry.add_magic_spritelayout(
    type="jetty_auto_orient_to_coast_direction",
    base_id="oil_trading_port_spritelayout_water_barge_1",
    tile="oil_trading_port_tile_3",
    config={
...
industry.add_magic_spritelayout(
    type="jetty_auto_orient_to_coast_direction",
    base_id="oil_trading_port_spritelayout_water_barge_2",
    tile="oil_trading_port_tile_3",
    config={
        "jetty_foundations": False,
        "building_sprites": {
...
industry.add_industry_jetty_layout(
    id="oil_trading_port_industry_layout_1",
    layout=[
        (0, 0, "oil_trading_port_spritelayout_coast_office"),
        (0, 1, "oil_trading_port_spritelayout_large_tank"),
        (0, 2, "oil_trading_port_spritelayout_large_tank"),
        (0, 3, "oil_trading_port_spritelayout_small_tanks"),
        (0, 4, "spritelayout_null_water"),
        (1, 0, "oil_trading_port_spritelayout_sphere_tank"),
        (1, 1, "oil_trading_port_spritelayout_sphere_tank"),
        (1, 2, "oil_trading_port_spritelayout_water_barge_2"),
        (1, 3, "spritelayout_null_water"),
        (1, 4, "spritelayout_null_water"),
        (2, 0, "oil_trading_port_spritelayout_large_tank"),
        (2, 1, "oil_trading_port_spritelayout_large_tank"),
        (2, 2, "oil_trading_port_spritelayout_small_tanks"),
        (2, 3, "oil_trading_port_spritelayout_small_tanks"),
        (2, 4, "spritelayout_null_water"),
        (2, 5, "spritelayout_null_water"),
        (3, 0, "oil_trading_port_spritelayout_large_tank"),
        (3, 1, "oil_trading_port_spritelayout_large_tank"),
        (3, 2, "oil_trading_port_spritelayout_water_barge_1"),
        (3, 3, "spritelayout_null_water"),
    ],
)

industry.add_industry_jetty_layout(
    id="oil_trading_port_industry_layout_2",
    layout=[
        (0, 0, "oil_trading_port_spritelayout_large_tank"),
        (0, 1, "oil_trading_port_spritelayout_large_tank"),
        (1, 0, "oil_trading_port_spritelayout_large_tank"),
        (1, 1, "oil_trading_port_spritelayout_large_tank"),
        (1, 2, "oil_trading_port_spritelayout_small_tanks"),
        (1, 3, "oil_trading_port_spritelayout_small_tanks"),
        (1, 4, "spritelayout_null_water"),
        (1, 5, "spritelayout_null_water"),
        (2, 0, "oil_trading_port_spritelayout_coast_office"),
        (2, 1, "oil_trading_port_spritelayout_sphere_tank"),
        (2, 2, "oil_trading_port_spritelayout_water_barge_1"),
