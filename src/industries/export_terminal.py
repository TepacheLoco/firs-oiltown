...
industry.add_magic_spritelayout(
    ...
    base_id="export_terminal_spritelayout_coast_office",
...
industry.add_magic_spritelayout(
    type="jetty_auto_orient_to_coast_direction",
    base_id="export_terminal_spritelayout_sphere_tank",
...
industry.add_magic_spritelayout(
    type="jetty_auto_orient_to_coast_direction",
    base_id="export_terminal_spritelayout_small_tanks",
    tile="export_terminal_tile_1",
    config={
        "jetty_foundations": True,
        "building_sprites": {
...
industry.add_magic_spritelayout(
    type="jetty_auto_orient_to_coast_direction",
    base_id="export_terminal_spritelayout_large_tank",
    tile="export_terminal_tile_1",
    config={
        "jetty_foundations": True,
        "building_sprites": {
...
industry.add_magic_spritelayout(
    type="jetty_auto_orient_to_coast_direction",
    base_id="export_terminal_spritelayout_water_barge_1",
...
industry.add_magic_spritelayout(
    type="jetty_auto_orient_to_coast_direction",
    base_id="export_terminal_spritelayout_water_barge_2",
    tile="export_terminal_tile_3",
    config={
        "jetty_foundations": False,
        "building_sprites": {
...
industry.add_industry_jetty_layout(
    id="export_terminal_industry_layout_1",
    layout=[
        (0, 0, "export_terminal_spritelayout_coast_office"),
        (0, 1, "export_terminal_spritelayout_large_tank"),
        (0, 2, "export_terminal_spritelayout_large_tank"),
        (0, 3, "export_terminal_spritelayout_small_tanks"),
        (0, 4, "spritelayout_null_water"),
        (1, 0, "export_terminal_spritelayout_sphere_tank"),
        (1, 1, "export_terminal_spritelayout_sphere_tank"),
        (1, 2, "export_terminal_spritelayout_water_barge_2"),
        (1, 3, "spritelayout_null_water"),
        (1, 4, "spritelayout_null_water"),
        (2, 0, "export_terminal_spritelayout_large_tank"),
        (2, 1, "export_terminal_spritelayout_large_tank"),
        (2, 2, "export_terminal_spritelayout_small_tanks"),
        (2, 3, "export_terminal_spritelayout_small_tanks"),
        (2, 4, "spritelayout_null_water"),
        (2, 5, "spritelayout_null_water"),
        (3, 0, "export_terminal_spritelayout_large_tank"),
        (3, 1, "export_terminal_spritelayout_large_tank"),
        (3, 2, "export_terminal_spritelayout_water_barge_1"),
        (3, 3, "spritelayout_null_water"),
    ],
)

industry.add_industry_jetty_layout(
    id="export_terminal_industry_layout_2",
    layout=[
        (0, 0, "export_terminal_spritelayout_large_tank"),
        (0, 1, "export_terminal_spritelayout_large_tank"),
        (1, 0, "export_terminal_spritelayout_large_tank"),
        (1, 1, "export_terminal_spritelayout_large_tank"),
        (1, 2, "export_terminal_spritelayout_small_tanks"),
        (1, 3, "export_terminal_spritelayout_small_tanks"),
        (1, 4, "spritelayout_null_water"),
        (1, 5, "spritelayout_null_water"),
        (2, 0, "export_terminal_spritelayout_coast_office"),
        (2, 1, "export_terminal_spritelayout_sphere_tank"),
        (2, 2, "export_terminal_spritelayout_water_barge_1"),
