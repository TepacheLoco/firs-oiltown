...
First pass at building out the OilTown economy. Not savegame-compatible with upstream FIRS.

*New cargos (OIL_TOWN economy)*

- Treated Water (WATR) — potable; produced by Desalination Plant; town-happiness cargo (VTE_HAPPINESS, like food)
- Ethylene (ETHY) — liquid bulk, tanker-compatible
- Condensate (COND) — light hydrocarbon, optional refinery feedstock
- Lubricants (LUBR), Bitumen (BITU), Fracking Fluid (FFLD) — liquid bulk intermediates
- Enabled existing cargos in OIL_TOWN: chemicals, coke, coal tar, mail, food, fertiliser, plastics, engineering supplies, petrol

*Tier 1 — extraction*

- Desalination Plant (new, coastal) → treated water. Reuses Oil Trading Port sprites
- Fracking Well (new, onshore) — **requires** fracking fluid to operate; produces raw gas + condensate

*Tier 2 — primary processing*

- Coking Plant (new) → coal → coke + coal tar. Reuses Coke Oven sprites
- Oil Refinery — now accepts crude oil and condensate as alternative feedstocks (either alone gives full production)

*Tier 3 — petrochemistry*

- Naphtha Cracking Plant (new, renamed from Petrochemical Plant) → naphtha + refinery gas → ethylene + chemicals. Reuses Copper Smelter sprites
- Fracking Fluid Plant (new) → chemicals + treated water → fracking fluid. Reuses Tyre Plant sprites
- Chemical Plant — now enabled in OIL_TOWN: ethylene + sulphur + treated water → chemicals

*Tier 4 — processing*

- Lubricants Plant (new) → heavy oil + LNG → lubricants. Reuses Oil Refinery sprites
- Bitumen Plant (new) → heavy oil + coke → bitumen. Reuses Lime Kiln sprites
- Plastics Plant — now enabled in OIL_TOWN: ethylene + chemicals → plastics. Renamed display label from "PVC Plant" to "Plastics Plant"
- Fertiliser Plant — now enabled in OIL_TOWN: LNG + sulphur + chemicals → fertiliser
- Petroleum Fuels Depot (new) → light oil + chemicals + lubricants → petroleum fuels. Reuses Oil Refinery sprites
- Supply Yard — now enabled in OIL_TOWN as "Engineering Supplies Plant": lubricants + bitumen + coke + ethylene + coal tar → engineering supplies (delivering ENSP to tier-1 extractives boosts their throughput, ~+40%)

*Tier 5 — ports/sinks*

- Export Terminal (new, coastal) → chemicals + plastics + fertiliser → food. Reuses Oil Trading Port jetty layout
- Oil Trading Port — accepted cargos expanded to include petrol, LNG, LPG (in addition to crude/light/heavy oil)
- Pipeline Terminus (new, inland, rare) — inland sink accepting the same six cargos as Oil Trading Port. Reuses Gas Processing Plant sprites
- Coal Fired Power Station, Oil Fired Power Station, Natural Gas Power Station (new) — black-hole town sinks for coal / heavy oil / LNG respectively
- Water Tower (new, in-town) — accepts treated water (WATR), acts as the tertiary town delivery sink for water in OIL_TOWN (analogous to General Store for food elsewhere)

*Misc*

- LNG, LPG, raw gas, refinery gas now additionally carry CC_LIQUID_BULK so tanker trucks / tank wagons refit to them
- Cargo weights tuned to realistic liquid densities for the new cargos
